...
//     id: 1,
//     name: "Life Pulse",
//     image: "https://via.placeholder.com/500x300?text=Life+Pulse",
//     stack: ["MongoDB", "Express", "React", "Node.js", "Firebase", "Tailwind"],
//     description: "A blood donation web app with role-based dashboards and real-time donation management.",
//     liveLink: "https://lifepulse.example.com",
//     githubLink: "https://github.com/yourusername/lifepulse-client",
//     challenges: "Implementing JWT authentication with Firebase and real-time data updates.",
//     futurePlans: "Add AI-based donor matching and push notifications.",
//   },
//   {
//     id: 2,
//     name: "Share Bite",
//     image: "https://via.placeholder.com/500x300?text=Share+Bite",
//     stack: ["MongoDB", "Express", "React", "Node.js", "Tailwind", "Firebase"],
//     description: "A platform for reducing food waste by connecting donors with NGOs.",
//     liveLink: "https://sharebite.example.com",
//     githubLink: "https://github.com/yourusername/sharebite-client",
//     challenges: "Handling large media uploads and building an optimized search/filter system.",
...
//     challenges: "Making it fully responsive and implementing smooth animations.",
...
// const Projects = () => {
//   return (
//     <section id="projects" className="relative w-full min-h-screen px-5 md:px-20 py-20 bg-black overflow-hidden">
//       {/* Neon Glow Background */}
//       <div className="absolute inset-0 bg-gradient-to-br from-purple-900 via-black to-blue-900 animate-gradient"></div>

//       {/* Section Header */}
//       <h2 className="text-4xl md:text-5xl font-bold text-center text-white mb-12 relative z-10">
//         My Projects
//       </h2>
...
//               state={project}
//               className="block text-center bg-gradient-to-r from-purple-500 to-blue-500 text-white px-4 py-2 rounded-lg hover:opacity-90"
//             >
//               View More / Details
//             </Link>
//           </div>
